...
class EditTask extends StatefulWidget {
  final ToDo todo;
  final String taskId;
  const EditTask({Key? key, required this.todo, required this.taskId})
      : super(key: key);
...
class _EditTaskState extends State<EditTask> {
  ...
  void initState() {
    super.initState();
    _taskName.text = widget.todo.taskName;
    _taskDate.text = widget.todo.taskDate;
    _taskTime.text = widget.todo.taskTime;
    _taskDesc.text = widget.todo.taskDesc;
    taskTimeAlloted = widget.todo.taskTime;
